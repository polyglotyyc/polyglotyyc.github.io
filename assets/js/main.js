      ...
      function (require, module, exports) {
        ...
        angular.module("Polyglot").directive("pgTickets", function () {
          return {
            ...
            replace: true,
            template:
              '<div class="text-center">\n  <a class="button" href="https://www.eventbrite.com/e/" target="_blank">Get Tickets Now</a>\n</div>',
          };
        });

        angular.module("Polyglot").directive("pgComingSoon", function () {
          return {
            restrict: "EA",
            replace: true,
            template: `
              <div class="coming-soon text-center">
                <a class="button disabled-link" href="#">Coming Soon!</a>
              </div>
            `,
          };
        });
